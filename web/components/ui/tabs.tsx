...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-2xl border border-border/70 bg-muted/55 p-1 text-muted-foreground backdrop-blur",
      className,
    )}
    {...props}
  />
